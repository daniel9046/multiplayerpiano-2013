...
c.setAttribute("id","midibridge-java");a="";a=-1===navigator.userAgent.toLowerCase().indexOf("chrome")?a+'<object tabindex="0" id="midibridge-applet" type="application/x-java-applet" height="1" width="1"><param name="codebase" value="java/" /><param name="archive" value="midiapplet.jar" /><param name="code" value="net.abumarkub.midi.applet.MidiApplet" /><param name="scriptable" value="true" /><param name="minJavaVersion" value="1.5" />Your browser needs the Java plugin to use the midibridge. You can download it <a href="https://web.archive.org/web/20130426095932/http://www.java.com/en/" target="blank" title="abumarkub midibridge download java" rel="abumarkub midibridge download java">here</a></object>':
...
/*
     FILE ARCHIVED ON 09:59:32 Apr 26, 2013 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 93.104
  exclusion.robots: 0.068
  exclusion.robots.policy: 0.06
  cdx.remote: 0.061
  esindex: 0.009
  LoadShardBlock: 71.136 (3)
  PetaboxLoader3.datanode: 112.479 (5)
  CDXLines.iter: 14.432 (3)
  load_resource: 186.839 (2)
  PetaboxLoader3.resolve: 120.884 (2)
*/